...
while True:
    ...
    """for i in range(5):
        parsed[i] = json.loads(database_response[i])
    ...
    messages.append({"role": "system", "content": "Here is the chat history: " + str(history) + " Refer to this information is the user asks follow up questions."})
